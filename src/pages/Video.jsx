...
export const Video = () => {
  ...
  const handleSub = async () => {
    try {
      ...
      const actionUrl = (currentUser?.subscribedUsers?.includes(channel._id) ||
  ...
  const subscribedUsers = currentUser?.subscribedUsers?.includes(channel._id)||currentUser?.user?.subscribedUsers?.includes(channel._id);
      ...
      <Content className="mb-4">
        ...
        <Channel>
          ...
          <ChannelInfo className="">
            <Image src={channel.name} className="" />
            <ChannelDetail className="">
              <ChannelName>{channel.name}</ChannelName>
              <ChannelCounter>{channel.subscribers} Subscribers</ChannelCounter>
            </ChannelDetail>
          </ChannelInfo>
          {subscribedUsers? <Subscribed onClick={handleSub}>
               SUBSCRIBED
          </Subscribed> : 
